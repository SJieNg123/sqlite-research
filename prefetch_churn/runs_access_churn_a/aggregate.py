#!/usr/bin/env python3
"""Aggregate B1: A × delete-heavy churn × {static t=0 hot for 2d / 2e_k10 / 2e_k50}.
Compares decay vs baseline (n0) and against layers_92 (n92) from runs_nsweep_a/."""
import csv, statistics
from pathlib import Path

DIR = Path(__file__).parent
NSA = DIR.parent / "runs_nsweep_a"
...
sources = [
    ("n0_base",       NSA / "n0/benchmark_summary.csv"),
    ("n5_layers",     NSA / "n5/benchmark_summary.csv"),
    ("n92_layers",    NSA / "n92/benchmark_summary.csv"),
