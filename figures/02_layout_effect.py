...
Data (master batch, authoritative): results/main/summary.csv, Workload A, async arm,
first-query median of 10 reps (warmup dropped).
"""
from plot_utils import ROOT, save, load_summary, STRATEGY_COLORS
...
def fq(layout, s):
    return float(DATA[("A", layout, s)]['fq_median'])
