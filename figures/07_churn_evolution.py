"""Figure 7: First-query latency across churn checkpoints.
...
Data: results/churn/churn_evolution.csv — measurement via run_experiment (drop-caches +
...
CSVP = ROOT / "results/churn/churn_evolution.csv"
...
fig.suptitle("First-query vs churn · static t=0 hotset re-used across checkpoints",
             fontsize=12, y=1.0)
fig.tight_layout()
