"""Figure 9: Workload Z (low-key Zipfian) — robustness check on Workload A.
...
Data: results/nsweep_dense/summary.csv — layers_N × {A,Z} × {orig,vacuum,ta},
...
fig.suptitle("Workload Z robustness check — hotspot location changes, layers_N behaviour doesn't",
             fontsize=12, y=1.0)
fig.tight_layout()
