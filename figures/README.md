...
| 16 | [16_ram_pressure_sweep.py](16_ram_pressure_sweep.py) | [out/16_ram_pressure_sweep.png](out/16_ram_pressure_sweep.png) | Sub-working-set RAM-pressure sweep (cap {∞,16,12,8,6}M, below the ~17.3 MB WS). Targeted 2e_K10/K500 keep delivery≈100% and first-q flat (RAM-robust by construction); 2f_slru (dump = whole WS) collapses once the cap drops below it. | `results/ram_pressure/cap_*/summary.csv` |
