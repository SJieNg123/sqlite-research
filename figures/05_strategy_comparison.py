...
STRATS = STRAT_ORDER                      # baseline + 6 strategies
WORKLOADS = ["A", "B", "C"]
...
fig.suptitle("All strategies × layouts × workloads · async arm · first-query median",
             fontsize=12, y=1.10)
fig.tight_layout()
