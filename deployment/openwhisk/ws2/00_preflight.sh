...
# --- 7. stdlib unit tests (NOT pytest) ------------------------------------- #
r ""
r "## unit_tests (python3 -m unittest, stdlib only)"
run_unittest() {  # run_unittest <module>
  local mod="$1"
...
run_unittest tests.test_workload_naming
run_unittest deployment.openwhisk.tests.test_manifest_invariants
